...
if __name__ == "__main__":
    ...
    cnx = connect_mysql(os.getenv("SQL_HOST"), os.getenv("SQL_USERNAME"), os.getenv("SQL_PW"))
    ...
    # criando tabela
    create_product_table(cursor, "db_produtos_teste", "tb_livros_teste")
    show_tables(cursor, "db_produtos_teste")

    # lendo e adicionando os dados
    df = read_csv("../data_teste/tb_livros.csv")
    add_product_data(cnx, cursor, df, "db_produtos_teste", "tb_livros_teste")
